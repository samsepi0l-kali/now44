    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center bg-black px-4">
      ...
      >
        <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-10">
          {/* YouTube - Official with white play button */}
          ...
          {/* WhatsApp - Official WhatsApp icon with phone and chat */}
          <a href="https://wa.me/919839221161" className="text-gray-500 hover:text-[#25D366] transition-all duration-300 hover:scale-110" target="_blank" rel="noopener noreferrer">
            <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="currentColor">
